"Resource/HudLayout.res"
{
	...
	HudMedicCharge
	{
		...
		"enabled"		"1"
		"xpos"			"r174"	[$WIN32]
		"xpos_minmode"	"r476"	[$WIN32]
		"ypos"			"r89"	[$WIN32]
		"ypos_minmode"	"r118"	[$WIN32]
		"xpos"			"r174"	[$X360]
		"ypos"			"r90"	[$X360]
		"wide"			"200"
		"tall"			"100"
	...
	CHudAccountPanel
	{
		...
		"xpos"					"r194"	[$WIN32]
		"ypos"					"r174"	[$WIN32]
		"xpos_minmode"			"r472"	[$WIN32]
		"ypos_minmode"			"r193"	[$WIN32]
		"xpos"					"r194"	[$X360]
		"ypos"					"r174"	[$X360]
		"wide"					"116"
		"tall"  				"180"
	...
	DisguiseStatus
	{
		...
		"enabled"	"1"
		"xpos"		"60"	[$WIN32]
		"xpos_minmode"	"224"	[$WIN32]
		"ypos"		"r87"	[$WIN32]
		"ypos_minmode"	"331"	[$WIN32]
		"xpos"		"50"	[$X360]
		"ypos"		"330"	[$X360]
		"wide"		"500"
		"tall"		"200"
